  ...
  return (
    ...
    >
      <div className="max-w-[1895px] mx-auto w-full">
        ...
        <div className="hidden md:block w-full text-center" style={{ marginTop: 'clamp(40px, 8vw, 96px)', marginBottom: 'clamp(20px, 4vw, 40px)' }}>
          <h1 
        ...
        <div className="md:hidden w-full text-center" style={{ marginTop: 'clamp(20px, 4vw, 40px)', marginBottom: 'clamp(15px, 2vw, 30px)' }}>
          <h1 
